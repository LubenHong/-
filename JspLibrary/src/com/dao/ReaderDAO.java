...
public ReaderForm queryM(ReaderForm readerForm){
    ...
    try {
        while (rs.next()) {
            ...
            System.out.println("setPaperType(rs.getString(2)):"+rs.getString(2));
            ...
            System.out.println("setPaperType(rs.getString(7)):"+rs.getString(7));
            ...
            System.out.println("setPaperType(rs.getString(7)):"+rs.getString(13));

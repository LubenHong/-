...
function check(form){
	...
	if(form.birthday.value==""){
		alert("出生日期不能为空");form.paperNO.focus();return false;
	}
		if(form.paperNO.value==""){
		...
		{          
			    form.email.value="";
			    alert("请输入格式正确的 e-mail 地址！");form.email.focus();return false;
		} 
...
<%}%> 
      ...
      <tr>
        ...
        <td><input name="birthday" type="text" id="birthday" value="<%=birthday%>" >&nbsp;*(格式为：1991-01-01)</td>
      </tr>
      <tr>

...
function check(form){
	if(form.barcode.value==""){
		alert("图书条形码不能为空!");form.barcode.focus();return false;
	}else if(form.barcode.value.length!=9){
		alert("请正确的条形码!");form.barcode.focus();return false;
	}
	if(form.bookName.value==""){
		alert("图书名称不能为空!");form.bookName.focus();return false;
	}
	if(form.price.value==""){
		alert("图书定价不能为空!");form.price.focus();return false;
	}
}
</script>
<head>
...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
	...
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td width="173" align="center">图书条形码：</td>
